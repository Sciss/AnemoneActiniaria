val x = play {
  ...
  val syncSaw_0       = SyncSaw.ar(syncFreq = 0.01, sawFreq = 0.01)
  val eq              = syncSaw_0 sig_== 0.001002046
  val tailLevel       = eq atan2 1.4401373
  val latoocarfianN   = LatoocarfianN.ar(freq = 0.41197228, a = 3.0, b = 0.5, c = 0.5, d = -0.008222404, xi = 662.35516, yi = 3721.9795)
  ...
  val lFPar_0         = LFPar.ar(freq = 5.212914, iphase = 1.0)
  val in_2            = LeakDC.ar(0.01761304, coeff = 0.995)
  ...
  val in_3            = LeakDC.ar(0.27556488, coeff = 0.995)
  ...
  val in_4            = SyncSaw.ar(syncFreq = 0.01, sawFreq = 440.0)
  val a_0             = Lag3.ar(in_4, time = 0.32421353)
  val in_5            = LeakDC.ar(0.42644614, coeff = 0.995)
  ...
  val gbmanL          = GbmanL.ar(freq = 0.42644614, xi = 3304.8223, yi = 0.0)
  val in_8            = LeakDC.ar(0.017735861, coeff = 0.995)
  ...
  val in_9            = LeakDC.ar(0.4886342, coeff = 0.995)
  ...
  val in_10           = GVerb.ar(in_9, roomSize = roomSize, revTime = revTime, damping = damping_0, inputBW = 0.007950359, spread = 43.0, dryLevel = -0.010030854, earlyRefLevel = 0.0062145633, tailLevel = tailLevel, maxRoomSize = 38.01318)
  val bitXor          = in_10 ^ -0.008222404
  val hypot           = lFPar_0 hypot in_10
  val in_11           = LeakDC.ar(0.017735861, coeff = 0.995)
  val lag2_2          = Lag2.ar(in_11, time = 0.63454044)
  val in_12           = LeakDC.ar(7.144484, coeff = 0.995)
  val bRF_0           = BRF.ar(in_12, freq = 10.0, rq = 0.27556488)
  val ring2           = 7.382483 ring2 clip2
  val lFTri           = LFTri.ar(freq = 0.63454044, iphase = 0.0)
  ...
  val in_13           = LeakDC.ar(0.27556488, coeff = 0.995)
  ...
  val in_14           = LeakDC.ar(18.501421, coeff = 0.995)
  val hPF             = HPF.ar(in_14, freq = 10.0)
  val in_15           = LeakDC.ar(0.056376386, coeff = 0.995)
  ...
  val in_16           = LeakDC.ar(0.059060287, coeff = 0.995)
  ...
  val in_17           = LeakDC.ar(3739.0295, coeff = 0.995)
  ...
  val in_18           = SyncSaw.ar(syncFreq = 1.892141, sawFreq = 0.41197228)
  ...
  val gVerb           = GVerb.ar(in_19, roomSize = 0.55, revTime = 0.63454044, damping = damping_1, inputBW = inputBW_0, spread = 0.011486273, dryLevel = 0.056376386, earlyRefLevel = -0.0014914646, tailLevel = 0.42644614, maxRoomSize = 0.55)
  val hypotx          = 3721.9795 hypotx freq_0
  val in_20           = LeakDC.ar(0.4886342, coeff = 0.995)
  val lag2_3          = Lag2.ar(in_20, time = 30.0)
  val lt              = 5.212914 < hPF
  val in_21           = LeakDC.ar(-0.0014914646, coeff = 0.995)
  val twoPole         = TwoPole.ar(in_21, freq = 6079.9946, radius = 1.0)
  val in_22           = LeakDC.ar(0.63454044, coeff = 0.995)
  val bRF_1           = BRF.ar(in_22, freq = 10.0, rq = 100.0)
  val in_23           = LeakDC.ar(-0.0014914646, coeff = 0.995)
  ...
  val pan2            = Pan2.ar(in_25, pos = 0.0, level = 1.0)
  val sig = Resonz.ar(pan2, "freq".kr(777), rq = 1)
  Out.ar(6, Limiter.ar(LeakDC.ar(sig)) * "amp".kr(0.2))
}
