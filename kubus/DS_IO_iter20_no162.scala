val x = play {
  ...
  val yi              = LFDNoise3.ar(1551.5026)
  val width           = yi max 0.0
  val in_0            = VarSaw.ar(freq = 100.5704, iphase = 0.0, width = width)
  val twoPole         = TwoPole.ar(in_0, freq = 55.773136, radius = 1.0)
  val scaleneg        = twoPole scaleneg 0.0014409359
  val in_1            = LeakDC.ar(0.016513553, coeff = 0.995)
  val oneZero         = OneZero.ar(in_1, coeff = 1.0)
  val mod             = twoPole % oneZero
  val in_2            = LeakDC.ar(0.35691246, coeff = 0.995)
  val k               = DelayN.ar(in_2, maxDelayTime = 20.0, delayTime = 0.23810405)
  val gbmanL          = GbmanL.ar(freq = 55.773148, xi = 100.5704, yi = 163.37988)
  val b_0             = LFDNoise3.ar(1551.5026)
  ...
  val in_3            = LeakDC.ar(2.3382738, coeff = 0.995)
  ...
  val in_11           = LeakDC.ar(8.832454, coeff = 0.995)
  ...
  val in_12           = LeakDC.ar(-68.48215, coeff = 0.995)
  ...
  val pan2            = Pan2.ar(in_14, pos = 0.0, level = 1.0)
